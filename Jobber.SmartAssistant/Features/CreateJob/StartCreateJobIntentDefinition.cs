    ...
    public class StartCreateJobIntentDefinition : IIntentDefinition
    {
        public Intent DefineIntent()
        {
            return IntentBuilder.For(Constants.StartCreateJob)
                ...
                .TriggerOn($"I want to add a job for [{Entity.Any}:{Constants.ClientNameVar}:John Appleseed]")
                .RequireParameter(ParameterBuilder.Of(Constants.ClientNameVar, Entity.Any)
